 ...
 */const e={autoplay:!1,loop:!1,mute:!1,volume:100,showControls:!0,accessibilityHidden:!1,youtubeHost:"https://www.youtube.com",vimeoHost:"https://player.vimeo.com",startTime:0,endTime:0};let t,i=0;class s{constructor(t,i){this.type="none",this.destroyed=!1,this.url=t,this.options_default={...e},this.options=function(e,...t){const i=e||{};return Object.keys(t).forEach(e=>{const s=t[Number(e)];s&&Object.keys(s).forEach(e=>{const t=e,o=s[t];void 0!==o&&(i[t]=o)})}),i}({...this.options_default},i),this.videoID=this.constructor.parseURL(t),this.videoID&&this.init()}isValid(){return!!this.videoID}init(){this.ID=i,i+=1,this.playerID=`VideoWorker-${this.ID}`}on(e,t){this.userEventsList=this.userEventsList||{},this.userEventsList[e]||(this.userEventsList[e]=[]),this.userEventsList[e].push(t)}off(e,t){this.userEventsList&&this.userEventsList[e]&&(t?this.userEventsList[e].forEach((i,s)=>{var o;if(i===t){const t=null==(o=this.userEventsList)?void 0:o[e];t&&(t[s]=!1)}}):delete this.userEventsList[e])}fire(e,...t){this.userEventsList&&void 0!==this.userEventsList[e]&&this.userEventsList[e].forEach(e=>{e&&e.apply(this,t)})}static parseURL(e){return!1}play(e){}pause(){}mute(){}unmute(){}setVolume(e=!1){}getVolume(e){}getMuted(e){}setCurrentTime(e=!1){}getCurrentTime(e){}getImageURL(e){}getVideo(e){}destroy(){var e,t;this.destroyed=!0,this.userEventsList=void 0,(null==(e=this.$video)?void 0:e.parentNode)&&this.$video.parentNode.removeChild(this.$video),(null==(t=this.hiddenContainer)?void 0:t.parentNode)&&this.hiddenContainer.parentNode.removeChild(this.hiddenContainer),this.player=void 0,this.$video=void 0,this.hiddenContainer=void 0}}class o{constructor(){this.doneCallbacks=[],this.failCallbacks=[]}execute(e,t){let i=e.length;for(;i;)i-=1,e[i](...t)}resolve(...e){this.execute(this.doneCallbacks,e)}reject(...e){this.execute(this.failCallbacks,e)}done(e){this.doneCallbacks.push(e)}fail(e){this.failCallbacks.push(e)}}t="undefined"!=typeof window?window:"undefined"!=typeof self?self:globalThis;var r=t;function a(e){return e.replace(/\/+$/,"")}let n=0,h=0;const l=new o,d=r;let p=0,u=0;const m=new o,v=r;const y=function(e,t){let i=!1;return Object.keys(y.providers).forEach(s=>{!i&&y.providers[s].parseURL(e)&&(i=new y.providers[s](e,t))}),i||new s(e,t)};let c;y.BaseClass=s,y.providers={Youtube:class extends s{constructor(){super(...arguments),this.type="youtube"}static parseURL(e){const t=e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|shorts\/|watch\?v=)([^#&?]*).*/);return!(!t||11!==t[1].length)&&t[1]}init(){super.init(),function(){if(p)return;p=1;let e=document.createElement("script"),t=document.getElementsByTagName("head")[0]||null;t&&e&&(e.src="https://www.youtube.com/iframe_api",t.appendChild(e),t=null,e=null)}()}play(e){this.player&&this.player.playVideo&&v.YT&&(void 0!==e&&this.player.seekTo(e||0),v.YT.PlayerState.PLAYING!==this.player.getPlayerState()&&(this.options.endTime&&!this.options.loop?this.getCurrentTime(e=>{var t;e<this.options.endTime&&(null==(t=this.player)||t.playVideo())}):this.player.playVideo()))}pause(){this.player&&this.player.pauseVideo&&v.YT&&v.YT.PlayerState.PLAYING===this.player.getPlayerState()&&this.player.pauseVideo()}mute(){this.player&&this.player.mute&&this.player.mute()}unmute(){this.player&&this.player.unMute&&this.player.unMute()}setVolume(e=!1){this.player&&"number"==typeof e&&this.player.setVolume&&this.player.setVolume(e)}getVolume(e){this.player?this.player.getVolume&&e(this.player.getVolume()):e(!1)}getMuted(e){this.player?this.player.isMuted&&e(this.player.isMuted()):e(null)}setCurrentTime(e=!1){this.player&&"number"==typeof e&&this.player.seekTo&&this.player.seekTo(e)}getCurrentTime(e){this.player&&this.player.getCurrentTime&&e(this.player.getCurrentTime())}getEndTime(){var e;if(this.options.endTime||!this.options.loop)return this.options.endTime;const t=this.observedDuration||(null==(e=this.player)?void 0:e.getDuration())||0;return t>.3?t-.3:0}getImageURL(e){if(this.videoImage)return void e(this.videoImage);const t=["maxresdefault","sddefault","hqdefault","0"];let i=0;const s=new Image;s.onload=()=>{120!==(s.naturalWidth||s.width)||i===t.length-1?(this.videoImage=`https://img.youtube.com/vi/${String(this.videoID)}/${t[i]}.jpg`,e(this.videoImage)):(i+=1,s.src=`https://img.youtube.com/vi/${String(this.videoID)}/${t[i]}.jpg`)},s.src=`https://img.youtube.com/vi/${String(this.videoID)}/${t[i]}.jpg`}getVideo(e){this.destroyed||(this.$video?e(this.$video):function(e){void 0!==v.YT&&0!==v.YT.loaded||u?"object"==typeof v.YT&&1===v.YT.loaded?e():m.done(()=>{e()}):(u=1,v.onYouTubeIframeAPIReady=()=>{v.onYouTubeIframeAPIReady=null,m.resolve("done"),e()})}(()=>{if(this.destroyed)return;let t;this.$video||(t=document.createElement("div"),t.style.display="none"),this.playerOptions={host:a(this.options.youtubeHost),videoId:String(this.videoID),playerVars:{autohide:1,rel:0,autoplay:0,playsinline:1},events:{onReady:e=>{this.options.mute?e.target.mute():"number"==typeof this.options.volume&&e.target.setVolume(this.options.volume),this.options.autoplay&&this.play(this.options.startTime),this.fire("ready",e),this.volumeChangeInterval&&clearInterval(this.volumeChangeInterval),this.volumeChangeInterval=setInterval(()=>{this.getVolume(t=>{"number"==typeof t&&this.options.volume!==t&&(this.options.volume=t,this.fire("volumechange",e))})},150)},onStateChange:()=>{},onError:e=>{this.fire("error",e)}}},this.options.showControls||(this.playerOptions.playerVars.iv_load_policy=3,this.playerOptions.playerVars.modestbranding=1,this.playerOptions.playerVars.controls=0,this.playerOptions.playerVars.showinfo=0,this.playerOptions.playerVars.disablekb=1);let i=!1;this.playerOptions.events.onStateChange=e=>{v.YT&&this.player&&(e.data===v.YT.PlayerState.ENDED&&(this.observedDuration=this.player.getCurrentTime(),this.options.loop&&this.play(this.options.startTime)),i||e.data!==v.YT.PlayerState.PLAYING||(i=!0,this.fire("started",e)),e.data===v.YT.PlayerState.PLAYING&&this.fire("play",e),e.data===v.YT.PlayerState.PAUSED&&this.fire("pause",e),e.data===v.YT.PlayerState.ENDED&&this.fire("ended",e),e.data===v.YT.PlayerState.PLAYING?(this.progressInterval&&clearInterval(this.progressInterval),this.progressInterval=setInterval(()=>{if(!this.player)return;this.fire("timeupdate",e);const t=this.getEndTime();t&&this.player.getCurrentTime()>=t&&(this.options.loop?this.play(this.options.startTime):this.pause())},150)):this.progressInterval&&(clearInterval(this.progressInterval),this.progressInterval=void 0))};const s=!this.$video;if(s&&t){this.hiddenContainer=t;const e=document.createElement("div");e.setAttribute("id",this.playerID),t.appendChild(e),document.body.appendChild(t)}this.player=this.player||new v.YT.Player(this.playerID,this.playerOptions),s&&(this.$video=document.getElementById(this.playerID),this.$video&&this.options.accessibilityHidden&&(this.$video.setAttribute("tabindex","-1"),this.$video.setAttribute("aria-hidden","true")),this.$video&&(this.videoWidth=parseInt(this.$video.getAttribute("width")||"1280",10)||1280,this.videoHeight=parseInt(this.$video.getAttribute("height")||"720",10)||720)),e(this.$video)}))}destroy(){var e;this.progressInterval&&(clearInterval(this.progressInterval),this.progressInterval=void 0),this.volumeChangeInterval&&(clearInterval(this.volumeChangeInterval),this.volumeChangeInterval=void 0),(null==(e=this.player)?void 0:e.destroy)&&this.player.destroy(),super.destroy()}},Vimeo:class extends s{constructor(){super(...arguments),this.type="vimeo"}static parseURL(e){const t=e.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/);return!!(null==t?void 0:t[3])&&t[3]}static parseURLHash(e){const t=e.match(/^.*(vimeo.com\/|video\/)(\d+)(\?.*&*h=|\/)+([\d,a-f]+)/);return t&&5===t.length?t[4]:null}init(){super.init(),function(){if(n)return;if(n=1,void 0!==d.Vimeo)return;let e=document.createElement("script"),t=document.getElementsByTagName("head")[0]||null;t&&e&&(e.src="https://player.vimeo.com/api/player.js",t.appendChild(e),t=null,e=null)}()}play(e){this.player&&(void 0!==e&&this.player.setCurrentTime(e),this.player.getPaused().then(e=>{var t;e&&(this.options.endTime&&!this.options.loop?this.getCurrentTime(e=>{var t;e<this.options.endTime&&(null==(t=this.player)||t.play())}):null==(t=this.player)||t.play())}))}pause(){this.player&&this.player.getPaused().then(e=>{var t;e||null==(t=this.player)||t.pause()})}mute(){this.player&&this.player.setVolume&&this.setVolume(0)}unmute(){this.player&&this.player.setVolume&&this.setVolume(this.options.volume||100)}setVolume(e=!1){this.player&&"number"==typeof e&&this.player.setVolume&&this.player.setVolume(e/100)}getVolume(e){this.player?this.player.getVolume&&this.player.getVolume().then(t=>{e(100*t)}):e(!1)}getMuted(e){this.player?this.player.getVolume&&this.player.getVolume().then(t=>{e(0===t)}):e(null)}setCurrentTime(e=!1){this.player&&"number"==typeof e&&this.player.setCurrentTime&&this.player.setCurrentTime(e)}getCurrentTime(e){this.player&&this.player.getCurrentTime&&this.player.getCurrentTime().then(t=>{e(t)})}getImageURL(e){if(this.destroyed)return;if(this.videoImage)return void e(this.videoImage);let t=r.innerWidth||1920;r.devicePixelRatio&&(t*=r.devicePixelRatio),t=Math.min(t,1920);const i=new XMLHttpRequest;this.imageRequest=i,i.open("GET",`https://vimeo.com/api/oembed.json?url=${this.url}&width=${t}`,!0),i.onreadystatechange=()=>{if(4===i.readyState){if(i.status>=200&&i.status<400){const t=JSON.parse(i.responseText);t.thumbnail_url&&(this.videoImage=t.thumbnail_url,e(this.videoImage))}this.imageRequest=void 0}},i.send()}getVideo(e){this.destroyed||(this.$video?e(this.$video):function(e){if(void 0!==d.Vimeo||h)void 0!==d.Vimeo?e():l.done(()=>{e()});else{h=1;const t=setInterval(()=>{void 0!==d.Vimeo&&(clearInterval(t),l.resolve("done"),e())},20)}}(()=>{if(this.destroyed)return;let t;this.$video||(t=document.createElement("div"),t.style.display="none"),this.playerOptions={dnt:1,id:String(this.videoID),autopause:0,transparent:0,autoplay:this.options.autoplay?1:0,loop:this.options.loop?1:0,muted:this.options.mute||0===this.options.volume?1:0};const i=this.constructor.parseURLHash(this.url);if(i&&(this.playerOptions.h=i),this.options.showControls||(this.playerOptions.controls=0),!this.options.showControls&&this.options.loop&&this.options.autoplay&&(this.playerOptions.background=1),!this.$video&&t){this.hiddenContainer=t;let e="";Object.keys(this.playerOptions).forEach(t=>{var i;const s=t,o=null==(i=this.playerOptions)?void 0:i[s];void 0!==o&&(""!==e&&(e+="&"),e+=`${t}=${encodeURIComponent(String(o))}`)}),this.$video=document.createElement("iframe"),this.$video.setAttribute("id",this.playerID),this.$video.setAttribute("src",`${a(this.options.vimeoHost)}/video/${String(this.videoID)}?${e}`),this.$video.setAttribute("frameborder","0"),this.$video.setAttribute("mozallowfullscreen",""),this.$video.setAttribute("allowfullscreen",""),this.$video.setAttribute("allow","autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"),this.$video.setAttribute("title","Vimeo video player"),this.options.accessibilityHidden&&(this.$video.setAttribute("tabindex","-1"),this.$video.setAttribute("aria-hidden","true")),t.appendChild(this.$video),document.body.appendChild(t)}this.player=this.player||new d.Vimeo.Player(this.$video,this.playerOptions),this.options.mute||"number"!=typeof this.options.volume||this.setVolume(this.options.volume),this.options.startTime&&this.options.autoplay&&this.player.setCurrentTime(this.options.startTime),this.player.getVideoWidth().then(e=>{this.videoWidth=e||1280}),this.player.getVideoHeight().then(e=>{this.videoHeight=e||720});let s=!1;this.player.on("timeupdate",e=>{s||(this.fire("started",e),s=!0),this.fire("timeupdate",e),this.options.endTime&&e.seconds>=this.options.endTime&&(this.options.loop?this.play(this.options.startTime):this.pause())}),this.player.on("play",e=>{this.fire("play",e),this.options.startTime&&0===e.seconds&&this.play(this.options.startTime)}),this.player.on("pause",e=>{this.fire("pause",e)}),this.player.on("ended",e=>{this.fire("ended",e)}),this.player.on("loaded",e=>{this.fire("ready",e)}),this.player.on("volumechange",e=>{this.getVolume(e=>{"number"==typeof e&&(this.options.volume=e)}),this.fire("volumechange",e)}),this.player.on("error",e=>{this.fire("error",e)}),e(this.$video)}))}destroy(){var e;this.imageRequest&&(this.imageRequest.abort(),this.imageRequest=void 0),(null==(e=this.player)?void 0:e.destroy)&&this.player.destroy(),super.destroy()}},Local:class extends s{constructor(){super(...arguments),this.type="local"}static parseURL(e){const t=e.split(/,(?=mp4:|webm:|ogv:|ogg:)/),i={};let s=0;return t.forEach(e=>{const t=e.match(/^(mp4|webm|ogv|ogg):(.*)/);if((null==t?void 0:t[1])&&t[2]){const e="ogv"===t[1]?"ogg":t[1];i[e]=t[2],s=1}}),!!s&&i}play(e){this.player&&(void 0!==e&&(this.player.currentTime=e),this.player.paused&&(this.options.endTime&&!this.options.loop?this.getCurrentTime(e=>{var t;e<this.options.endTime&&(null==(t=this.player)||t.play())}):this.player.play()))}pause(){this.player&&!this.player.paused&&this.player.pause()}mute(){this.player&&this.$video&&(this.$video.muted=!0)}unmute(){this.player&&this.$video&&(this.$video.muted=!1)}setVolume(e=!1){this.player&&this.$video&&"number"==typeof e&&(this.$video.volume=e/100)}getVolume(e){this.player&&this.$video?e(100*this.$video.volume):e(!1)}getMuted(e){this.player&&this.$video?e(this.$video.muted):e(null)}setCurrentTime(e=!1){this.player&&this.$video&&"number"==typeof e&&(this.$video.currentTime=e)}getCurrentTime(e){this.player&&e(this.player.currentTime)}getImageURL(e){this.videoImage&&e(this.videoImage)}getVideo(e){if(this.destroyed)return;if(this.$video)return void e(this.$video);let t;if(this.$video||(t=document.createElement("div"),t.style.display="none"),!this.$video&&t){this.$video=document.createElement("video"),this.player=this.$video,this.hiddenContainer=t,this.options.showControls&&(this.$video.controls=!0),"number"==typeof this.options.volume&&this.setVolume(this.options.volume),this.options.mute&&this.mute(),this.options.loop&&(this.$video.loop=!0),this.$video.setAttribute("playsinline",""),this.$video.setAttribute("webkit-playsinline",""),this.options.accessibilityHidden&&(this.$video.setAttribute("tabindex","-1"),this.$video.setAttribute("aria-hidden","true")),this.$video.setAttribute("id",this.playerID),t.appendChild(this.$video),document.body.appendChild(t),Object.keys(this.videoID).forEach(e=>{const t=this.videoID[e];t&&function(e,t,i){const s=document.createElement("source");s.src=t,s.type=i,e.appendChild(s)}(this.$video,t,`video/${e}`)});const e=this.player;let i=!1;this.eventHandlers={playing:e=>{i||this.fire("started",e),i=!0},timeupdate:e=>{this.fire("timeupdate",e),this.options.endTime&&this.player&&this.player.currentTime>=this.options.endTime&&(this.options.loop?this.play(this.options.startTime):this.pause())},play:e=>{this.fire("play",e)},pause:e=>{this.fire("pause",e)},ended:e=>{this.fire("ended",e)},loadedmetadata:e=>{this.player&&(this.videoWidth=this.player.videoWidth||1280,this.videoHeight=this.player.videoHeight||720,this.fire("ready",e),this.options.autoplay&&this.play(this.options.startTime))},volumechange:e=>{this.getVolume(e=>{"number"==typeof e&&(this.options.volume=e)}),this.fire("volumechange",e)},error:e=>{this.fire("error",e)}},e.addEventListener("playing",this.eventHandlers.playing),e.addEventListener("timeupdate",this.eventHandlers.timeupdate),e.addEventListener("play",this.eventHandlers.play),e.addEventListener("pause",this.eventHandlers.pause),e.addEventListener("ended",this.eventHandlers.ended),e.addEventListener("loadedmetadata",this.eventHandlers.loadedmetadata),e.addEventListener("volumechange",this.eventHandlers.volumechange),e.addEventListener("error",this.eventHandlers.error)}e(this.$video)}destroy(){this.player&&this.eventHandlers&&(this.player.removeEventListener("playing",this.eventHandlers.playing),this.player.removeEventListener("timeupdate",this.eventHandlers.timeupdate),this.player.removeEventListener("play",this.eventHandlers.play),this.player.removeEventListener("pause",this.eventHandlers.pause),this.player.removeEventListener("ended",this.eventHandlers.ended),this.player.removeEventListener("loadedmetadata",this.eventHandlers.loadedmetadata),this.player.removeEventListener("volumechange",this.eventHandlers.volumechange),this.player.removeEventListener("error",this.eventHandlers.error)),this.eventHandlers=void 0,super.destroy()}}},c="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};var g=c;let f;function b(){return void 0===f&&(f="function"==typeof g.matchMedia?g.matchMedia("(prefers-reduced-motion: reduce)"):null),f?.matches??!1}function $(e=g.jarallax){if(void 0===e)return;const t=e.constructor,i=t.prototype.onScroll;t.prototype.onScroll=function(){i.apply(this);const e=(t=this,b()&&"local"===t.video?.type&&!t.defaultInitImgResult);var t;!this.isVideoInserted&&this.video&&(!this.options.videoLazyLoading||this.isElementInViewport)&&!this.options.disableVideo()&&(!b()||e)&&(this.isVideoInserted=!0,this.video?.getVideo(t=>{const i=t,s=i.parentNode;this.css(i,{position:this.image.position,top:"0px",left:"0px",right:"0px",bottom:"0px",width:"100%",height:"100%",maxWidth:"none",maxHeight:"none",pointerEvents:"none",transformStyle:"preserve-3d",backfaceVisibility:"hidden",margin:0,zIndex:-1}),this.$video=i,"local"===this.video?.type&&(e?this.css(i,{objectFit:"cover"}):this.image.src?i.setAttribute("poster",this.image.src):"IMG"===this.image.$item?.tagName&&i.setAttribute("poster",this.image.$item.src)),this.options.videoClass&&i.setAttribute("class",`${this.options.videoClass} ${this.options.videoClass}-${this.video?.type}`),this.image.$container?.appendChild(i),s?.parentNode?.removeChild(s),this.options.onVideoInsert?.call(this)}))};const s=t.prototype.coverImage;t.prototype.coverImage=function(){const e=s.apply(this),t=this.image.$item?.nodeName;if(!e||!0===e||!this.video||!t||"IFRAME"!==t&&"VIDEO"!==t||!this.$video)return e;let i=e.image.height,o=i*(this.image.width||0)/(this.image.height||1),r=(e.container.width-o)/2,a=e.image.marginTop;return e.container.width>o&&(o=e.container.width,i=o*(this.image.height||0)/(this.image.width||1),r=0,a+=(e.image.height-i)/2),"IFRAME"===t&&(i+=400,a-=200),this.css(this.$video,{width:`${o}px`,marginLeft:`${r}px`,height:`${i}px`,marginTop:`${a}px`}),e};const o=t.prototype.initImg;t.prototype.initImg=function(){const e=o.apply(this);return this.options.videoSrc||(this.options.videoSrc=this.$item.getAttribute("data-jarallax-video")||null),this.options.videoSrc?(this.defaultInitImgResult=e,!0):e};const r=t.prototype.canInitParallax;t.prototype.canInitParallax=function(){let e=r.apply(this);if(!this.options.videoSrc)return e;const t=new y(this.options.videoSrc,{autoplay:!b(),loop:this.options.videoLoop,showControls:!1,accessibilityHidden:!0,startTime:Number(this.options.videoStartTime||0),endTime:Number(this.options.videoEndTime||0),mute:!Number(this.options.videoVolume),volume:Number(this.options.videoVolume||0),youtubeHost:this.options.videoYoutubeHost||void 0,vimeoHost:this.options.videoVimeoHost||void 0});this.options.onVideoWorkerInit?.call(this,t);const i=()=>{this.image.$default_item&&(this.image.$item=this.image.$default_item,this.image.$item.style.display="block",this.coverImage(),this.onScroll())};return t.isValid()?(this.options.disableParallax()&&(e=!0,this.image.position="absolute",this.options.type="scroll",this.options.speed=1),e?(t.on("ready",()=>{if(!b())if(this.options.videoPlayOnlyVisible){const e=this.onScroll;this.onScroll=function(){e.apply(this),this.videoError||!this.options.videoLoop&&(this.options.videoLoop||this.videoEnded)||(this.isVisible()?t.play():t.pause())}}else t.play()}),t.on("started",()=>{this.image.$default_item=this.image.$item,this.image.$item=this.$video,this.image.width=this.video?.videoWidth||1280,this.image.height=this.video?.videoHeight||720,this.coverImage(),this.onScroll(),this.image.$default_item&&(this.image.$default_item.style.display="none")}),t.on("ended",()=>{this.videoEnded=!0,this.options.videoLoop||i()}),t.on("error",()=>{this.videoError=!0,i()}),this.video=t,this.defaultInitImgResult||(this.image.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7","local"===t.type)?e:(t.getImageURL(e=>{this.image.bgImage=`url("${e}")`,this.init()}),!1)):(this.defaultInitImgResult||t.getImageURL(e=>{const t=this.$item.getAttribute("style");t&&this.$item.setAttribute("data-jarallax-original-styles",t),this.css(this.$item,{backgroundImage:`url("${e}")`,backgroundPosition:"center",backgroundSize:"cover"})}),e)):e};const a=t.prototype.destroy;t.prototype.destroy=function(){this.image.$default_item&&(this.image.$item=this.image.$default_item,delete this.image.$default_item),a.apply(this)}}var I;return $(),I=()=>{void 0!==g.jarallax&&g.jarallax(document.querySelectorAll("[data-jarallax-video]"))},"undefined"!=typeof document&&("complete"===document.readyState||"interactive"===document.readyState?I():document.addEventListener("DOMContentLoaded",I,{capture:!0,once:!0,passive:!0})),g.VideoWorker||(g.VideoWorker=y),$});//# sourceMappingURL=jarallax-video.min.js.map
